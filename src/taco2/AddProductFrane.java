...
public class AddProductFrane extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AddProductFrane
     */
    private File file;
    int xx, xy;
    Dao dao = new Dao();
    public AddProductFrane() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddProductFrane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
